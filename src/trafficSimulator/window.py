...
class Window:
    ...
    # def draw_enter(self):
    #     text_fps = self.text_font.render(f'Entrada', False, (255, 255, 255))
    #     text_frc = self.text_font.render(f'Salida', False, (255, 255, 255))
        
    #     self.screen.blit(text_fps, (500, 600))
    #     self.screen.blit(text_frc, (500, 500))
